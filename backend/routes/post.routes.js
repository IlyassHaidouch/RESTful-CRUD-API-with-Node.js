...
router.get("/", getPosts);  // ça veut dire que notre serveur il comprend la route qu on lui donne et il arrive a nous formuler une response  


router.post("/", setPosts); 
// ça veut dire que dès que je vais te solliciter router.post tu vas me jouer la fonction setPots()
// req est la donnée qu on envoie pour faire notre requête ça peut donc être à l ID ou un message , et à la fin on renvoie une reponse res ,on peut s en tenir à ça 
